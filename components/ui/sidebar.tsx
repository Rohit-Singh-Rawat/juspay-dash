...
const sidebarMenuButtonVariants = cva(
	"peer/menu-button flex w-full truncate text-nowrap relative items-center gap-2 overflow-hidden rounded-lg py-1 px-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-1 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 before:content-[''] before:absolute before:top-0 before:left-0 before:rounded-md before:w-full before:h-full before:bg-sidebar-accent before:opacity-0 hover:before:opacity-100 active:before:opacity-100 before:transition-opacity before:-z-10 data-[active=true]:bg-sidebar-accent data-[active=true]:font-normal data-[active=true]:text-sidebar-accent-foreground data-[active=true]:before:content-[''] data-[active=true]:before:absolute data-[active=true]:before:left-0 data-[active=true]:before:top-1/2 data-[active=true]:before:-translate-y-1/2 data-[active=true]:before:w-1 data-[active=true]:before:h-4 data-[active=true]:before:rounded-full data-[active=true]:before:bg-[#1C1C1C] dark:data-[active=true]:before:bg-[#C6C7F8] data-[active=true]:before:opacity-100 data-[active=true]:before:z-10 data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
	{
		variants: {
			variant: {
